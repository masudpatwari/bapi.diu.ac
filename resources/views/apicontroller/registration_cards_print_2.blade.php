...
<div style="width: 100%; margin:0.3in; overflow: hidden; clear: both;">
    <div style="float: left; width: 3.2in; margin-left:0.8in; margin-right:0.3in;">
        <div style="width: 100%; height: 1.75in; clear: both; overflow: hidden; margin-top: -0.04in;">
            <img src="{{ $image }}" alt="" style="width: 1.40in;  height: 1.75in; float:right; margin-right:0.05in">
        </div>
        <div style="width: 100%; clear: both; overflow: hidden; font-size:16px; margin-top:1.6in">
            <div style="float: left; width: 2.2in; padding-left:4px;">{{ $cards_value->reg_code }}</div>
            <div style="float: left; width: 0.9in; padding-left:4px;">{{ $cards_value->session_name }}</div>
        </div>
    ...
    <div style="float: right; width: 5.1in; margin-left:1.6in; margin-right:0in;">
        ...
        <div style="width: 100%; clear: both; overflow: hidden; font-size:16px; margin-top:1.36in">
